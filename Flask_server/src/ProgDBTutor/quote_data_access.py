...
class DBConnection:
    def __init__(self, dbname, dbuser, userPassword, dbport, dbhost ):
        try:
            self.conn = psycopg2.connect(dbname=dbname, user=dbuser, password=userPassword, port=dbport, host=dbhost)
        except:
